...
def test_model(args):
    ...
    for cur_model in models:
        ...
        model = torch.load(join(args.save_path, cur_model), weights_only=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_lr', default=1.5e-05,
    ...
    parser.add_argument('--valid_steps', default=500,
